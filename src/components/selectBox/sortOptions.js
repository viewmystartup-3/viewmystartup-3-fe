...
export const myCompanySelectOptions = [
  { label: "나의 기업 선택 횟수 높은순", value: "selectedCompany_desc" },
  { label: "나의 기업 선택 횟수 낮은순", value: "selectedCompany_asc" },
  { label: "비교 기업 선택 횟수 높은순", value: "comparedCompany_desc" },
  { label: "비교 기업 선택 횟수 낮은순", value: "comparedCompany_asc" },
];
